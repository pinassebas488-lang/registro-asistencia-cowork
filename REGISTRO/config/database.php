...
class Database {
    ...
    public function __construct() {
        ...
        if (getenv('RENDER')) {
            // Configuración para Render (producción) - Usar variables exactas
            $this->host = getenv('HOST_DE_BASE_DE_DATOS') ?: 'localhost';
            $this->db_name = getenv('NOMBRE_BD') ?: 'registro_asistencia';
            $this->username = getenv('DB_USER') ?: 'postgres';
            $this->password = getenv('CONTRASEÑA_DE_LA_BASE_DE_DATOS') ?: '';
            $this->db_type = 'postgresql'; // Forzar PostgreSQL en producción
            
            error_log("Configuración Render - Host: " . $this->host . ", DB: " . $this->db_name . ", User: " . $this->username);
        } else {
            ...
            error_log("Configuración Local - Host: " . $this->host . ", DB: " . $this->db_name);
        }
    }
